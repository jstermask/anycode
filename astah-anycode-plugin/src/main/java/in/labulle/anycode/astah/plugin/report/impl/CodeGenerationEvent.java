...
public class CodeGenerationEvent implements ICodeGenerationEvent {
	private static final Logger LOG = LoggerFactory
			.getLogger(CodeGenerationEvent.class);
	...
	private CodeGenerationEvent(final File generatedFile,
	...
	private CodeGenerationEvent(final File generatedFile,
			final String templateName, final String umlElementName,
			Exception failure) {
		this(generatedFile, templateName, umlElementName,
				GenerationStatus.FAILURE);
		this.failureCause = failure;
	}

	public static CodeGenerationEvent success(final File generatedFile,
			final String templateName, final String umlElementName) {
		return new CodeGenerationEvent(generatedFile, templateName,
				umlElementName, GenerationStatus.SUCCESS);
	}

	public static CodeGenerationEvent failure(final String templateName,
			final String umlElementName, Exception e) {
	...
	public String toString() {
		return "[TPL|" + this.templateName + "] | [UML|" + this.umlElementName
				+ "] => " + status;
	}
